...
export const buildActionButtonHtml = (text: string, url: string): string => {
  return `
    <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse: collapse; margin: 12px 0 28px 0;">
      <tr>
        <td align="center" style="border-radius: 8px; background-color: #4F46E5;" bgcolor="#4F46E5">
          <a href="${url}" target="_blank" style="font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; font-size: 15px; font-weight: 600; color: #FFFFFF; text-decoration: none; display: inline-block; padding: 12px 28px; border-radius: 8px;">
            ${text}
          </a>
        </td>
      </tr>
